...
public class DatalakeLdapAuthenticatorFactory
        implements PasswordAuthenticatorFactory
{
    @Override
    public String getName()
    {
        return "bloomberg-ldap";
    }
    ...
    public PasswordAuthenticator create(Map<String, String> config)
    {
        Bootstrap app = new Bootstrap(
                ...
                binder -> {
                    ...
                    configBinder(binder).bindConfig(DatalakeLdapAuthenticatorConfig.class);
                    binder.bind(DatalakeLdapAuthenticator.class).in(Scopes.SINGLETON);
                });
        ...
        return injector.getInstance(DatalakeLdapAuthenticator.class);
    }
}
